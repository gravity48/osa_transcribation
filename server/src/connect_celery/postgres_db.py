...
from sqlalchemy import Integer, Text, Column, Boolean, TIMESTAMP, ForeignKey, Sequence, String, Time, VARCHAR, BLOB, DateTime, \
    SmallInteger
...
class SettingsDB:
    ...
    @open_session
    def write_percent(self, record_id, percent,
                      processed_record_id, session: Session = None):
